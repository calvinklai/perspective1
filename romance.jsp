...
{{"rate1"},{"options","Strongly disagree", "Moderately disagree", "Slightly disagree",  "Neither agree nor disagree", "Slightly agree", "Moderately agree", "Strongly agree"}},
{{"rate2"},{"options","Single, never been married", "In a relationship, never been married", "Living with a partner",  "Married", "Separated", "Divorced", "Widowed"}},
};

String[][][] romanceb =
{
{{"romanceb"}, {"nelem","4"},{"musthave","0"},{"group","0"},{"gminmax","4.4"},{"gplace","0"},{"gorder","0"},{"gsequence","fixed"},{"prefix","<br/><b>If I were looking for a partner, I would be willing to:</b><br/>"}},
{{"romanceb_date"},{"choices","rate1"},{"stem","Date a Black person."}},
{{"romanceb_live"},{"choices","rate1"},{"stem","Live with a Black romantic partner."}},
{{"romanceb_marry"},{"choices","rate1"},{"stem","Marry a Black romantic partner."}},
{{"romanceb_child"},{"choices","rate1"},{"stem","Have a child with a Black romantic partner."}},
};

String[][][] marital_status =
{
{{"marital_status"}, {"nelem","1"},{"musthave","0"},{"group","0"},{"gminmax","1.1"},{"gplace","0"},{"gorder","0"},{"gsequence","fixed"}},
{{"marital_status"},{"choices","rate2"},{"stem","What is your marital status?"}},
};
ArrayList <String[][][]> scales = new ArrayList <String[][][]> ();
scales.add(romanceb);
scales.add(marital_status);
int nscales= 2;
%>
<%!
