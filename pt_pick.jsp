...
String[][][] ratings =
{
{{"ratings"},{"ncols","4"},{"flow","horizontal"},{"direction","left"}},
{{"rate1"},{"options","1","2","3","4", "5", "6", "7", "8"}},
};

String[][][] implement_choice =
{
{{"implement_choice"}, {"nelem","1"},{"choices","rate1"},{"musthave","0"},{"group","0"},{"gminmax","1.1"},{"gplace","0"},{"gorder","0"},{"gsequence","random"}},
{{"implement_choice"},{"stem","Please select one of the eight boxes below."}}
};
...
<script language="JavaScript" type="text/javascript" src="/implicit/common/en-us/js/task.js"></script>
   ...
   <style type="text/css">
      ...
      .med {font-size: 16px; font-weight: bold}
       ...
       .medblue2 {font-size: 22px; line-height:150%;  color:#3333FF;}
...
// #BDEDFF light blue
 ...
 // var minselect = js_minselect[curitem];
  ...
  var buttonwidth=js_bwidths[curitem]+80;

  //var pctwidth=Math.floor(100/icols);

  var colwidth=buttonwidth;

  var prefix = '<button type="button" style="font-size:70; font-weight: bold;text-align:center; width:'+buttonwidth+'px; background-color:';
